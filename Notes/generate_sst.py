...
def generate_sst_dir(cls, out_file):
    template = f"""<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Class {cls} Social Science — Chapter Notes | NeoBranium</title>
      ...
      <nav class="nav-menu">
        ...
        <div class="nav-item">
          ...
          <div class="dropdown-menu">
            <div class="dropdown-submenu"><h5>Class 9</h5><ul><li><a href="class9-science-dir.html">Science</a></li><li><a href="class9-maths-dir.html">Mathematics</a></li><li><a href="class9-social-science-dir.html">Social Science</a></li></ul></div>
  ...
  <main>
    <div class="notes-container" style="max-width:1200px;margin:0 auto;padding:2rem;">
      ...
      <div class="directory-hero">
        <div class="subject-badge"><i class="fas fa-globe"></i> Social Science</div>
        <h1>Class {cls} Social Science — Chapter Notes</h1>
...
"""
    ...
    # We will generate placeholder chapters for Social Science
    subjects = ["History", "Geography", "Political Science", "Economics"]
    html_chaps = ""
    for subj in subjects:
        for i in range(1, 6): # 5 chapters each
            title = f"{subj} - Chapter {i}"
            ch_num = f"{subj[:3].upper()}{i}"
            file_link = f"{cls}-SST-{ch_num}.html"
            html_chaps += f"""
        <a href="{file_link}" class="chapter-card">
          <div class="card-header">
            <h3>{title}</h3>
            <span class="chapter-number" style="background:#8b5cf620;color:#8b5cf6;">SST</span>
          </div>
...
generate_sst_dir(9, "/home/shubham_singh/Documents/NeoBranium/Notes/class9-social-science-dir.html")
generate_sst_dir(10, "/home/shubham_singh/Documents/NeoBranium/Notes/class10-social-science-dir.html")

# Generate the empty html files for those chapters
import os
for cls in [9, 10]:
    for subj in ["HIS", "GEO", "POL", "ECO"]:
        for i in range(1, 6):
            ch_num = f"{subj}{i}"
            file_link = f"{cls}-SST-{ch_num}.html"
...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Class {cls} Social Science - {subj} Chapter {i} | NeoBranium</title>
    <link rel="stylesheet" href="../index_css.css">
...
<body>
    <header>
        <div class="header-container">
            ...
            <nav class="nav-menu">
                <a href="../index.html">Home</a>
                <a href="class{cls}-social-science-dir.html">Back to Social Science</a>
            </nav>
        </div>
    </header>
