...
<head>
    ...
    <title>Class 10 Mathematics Chapter {num}: {title} | Detailed NCERT Notes | NeoBranium</title>
    <meta name="description" content="Class 10 Mathematics Chapter {num} - {title}. Detailed NCERT notes.">
    ...
    <header>
        <div class="header-container">
            ...
            <nav class="nav-menu">
                ...
                <div class="nav-item">
                    <a href="class10-maths-dir.html" class="active">Notes <i class="fas fa-chevron-down" style="font-size: 0.7rem;"></i></a>
    ...
    <main class="notes-page">
        ...
        <div class="notes-container">
            <nav class="breadcrumb">
                <a href="../index.html">Home</a> / <a href="class10-maths-dir.html">Notes</a> / <a href="class10-maths-dir.html">Class 10 Mathematics</a> / Chapter {num}: {title}
            </nav>
    ...
    <footer class="footer-container" style="margin-top: 2rem; border-top: 1px solid #e2e8f0; padding-top: 2rem;">
      ...
      <div class="footer-links">
        ...
        <ul>
          ...
          <li><a href="class10-maths-dir.html">Notes</a></li>
...
for i, title in enumerate(chapters, 1):
    file_path = f"/home/shubham_singh/Documents/NeoBranium/Notes/10-MATH-CH{i}.html"
